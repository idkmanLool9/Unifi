...
export const UBIQUITI_DEVICES: DeviceDefinition[] = [
  ...
  defineDevice({
    ...
    maximumPowerWatts: 0,
    description:
      '1U fixed cantilever shelf for mounting non-rackmount devices in standard 19" racks. Perforated deck for airflow with oblong cable pass-throughs at each corner.',
